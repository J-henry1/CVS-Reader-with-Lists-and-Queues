 ...
 * @author Jared Henry
 * 
 * Country class provides constructors, getters, setters, and print methods for Countries3.csv file
 * 
 * version 10/15/2022
 */
...
public class Country {
	 ...
	 * @param popDensity
	 */
	public Country(String name, String capital, double population, double gDP, double cOVIDCases, double cOVIDDeaths,
			double area, double gDPPC, double cFR, double caseRate, double deathRate, double popDensity) {
		this.name = name;
	...
	public String toString() {
	    return String.format("%-32s %-20s %-15.3f %-15.6f %-15.3f %-15.3f %-15.3f", name, capital,GDPPC,CFR,CaseRate,DeathRate,PopDensity);
	}
